...
const linkAccountText = computed<string>(() => { 
    return isLogin.value ? 'Создать сейчас?' : 'Войдите в него'
})
...
<template>
     <app-toast position="bottom-right" />
        <div class="flex justify-content-center p-2">
            ...
            <a class="font-medium no-underline ml-2 cursor-pointer link__AccountText" @click="toggleAuth">
                {{ linkAccountText }}
            </a>
        </div>
